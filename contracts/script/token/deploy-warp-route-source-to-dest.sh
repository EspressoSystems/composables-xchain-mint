...
forge script script/token/DeployEspHypNative.s.sol:DeployEspHypNativeScript --rpc-url $SOURCE_CHAIN_RPC_URL --private-key $DEPLOYER_PRIVATE_KEY --broadcast --via-ir
...
forge script script/token/DeployEspHypERC20.s.sol:DeployEspHypERC20Script --rpc-url $DESTINATION_CHAIN_RPC_URL --private-key $DEPLOYER_PRIVATE_KEY --broadcast --via-ir
