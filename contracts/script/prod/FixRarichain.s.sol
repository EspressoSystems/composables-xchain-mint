...
contract FixRarichain is Script {
    // ==================== NFT Config ====================
    string constant NAME = "Espresso Brews Ape";
    string constant SYMBOL = "BREW";
    string constant BASE_IMAGE_URI = "https://xchain-nft.s3.us-east-2.amazonaws.com/ape/";
    string constant CHAIN_NAME = "Ape";
    address constant ESP_HYP_ERC20 = 0x29b0a57Cb774f513653a90d3a185eb12D4AAc3ad;
    address constant PRICE_ADMIN = 0x740812DC83d6cE2a9bdde35aF54799097f355da1;
    uint256 constant NFT_SALE_PRICE = 1000000000000000; // 0.001 ETH
    uint256 constant START_SALE = 1765814400; // Mon Dec 15 17:00 CET 2025
    ...
    // ==================== Upgrade Config ====================
    address payable constant ESP_HYP_ERC20_PROXY = payable(0x29b0a57Cb774f513653a90d3a185eb12D4AAc3ad);
    ...
    // ==================== RPC ====================
    string constant RPC_URL = "https://rari.mainnet.on.espresso.network";

    function run() public {
        console.log("=== Fix Rarichain: Deploy NFT + Upgrade EspHypERC20 ===");
        console.log("");
